...
import com.example.instagram.databinding.ActivityChangeProfileBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imagePickerLauncher =
            registerForActivityResult(ActivityResultContracts.StartActivityForResult()) {
                ...
                glide.load(imageUri).into(binding.profileImg)
            }
                ...
                .enqueue(object : Callback<Any> {
                    override fun onResponse(call: Call<Any>, response: Response<Any>) {
                        if (response.isSuccessful) {
                            Toast.makeText(this@ChangeProfileActivity, "변경완료", Toast.LENGTH_SHORT)
                                .show()
                    ...
                    override fun onFailure(call: Call<Any>, t: Throwable) {
                        Toast.makeText(this@ChangeProfileActivity, "변경실패", Toast.LENGTH_SHORT)
                            .show()
                    }
                })
        }
